-- ============================================
-- SCRIPT SQL COMPLETO - RECREAR BASE DE DATOS
-- ============================================
-- Este script recrea TODA la base de datos desde cero
-- Incluye:
...
-- ⚠️ Hacer backup antes de ejecutar si tienes datos importantes
-- ============================================
...
-- ============================================
-- Compatible con ambos sistemas (reparaciones y gestión de órdenes)
CREATE TABLE users (
...
-- ============================================
-- 10. Tabla de Relación Orden-Servicios (Sistema Gestión Órdenes)
-- ============================================
...
-- ============================================
-- 11. Tabla de Notas de Órdenes (Sistema Gestión Órdenes)
-- ============================================
...
-- ============================================
-- 12. Tabla de Productos (Módulo Ventas y Stock)
-- ============================================
CREATE TABLE productos (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  codigo_barras TEXT, -- Opcional, único solo si existe
...
-- ============================================
-- 13. Tabla de Ventas (Módulo Ventas y Stock)
-- ============================================
CREATE TABLE ventas (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- ============================================
-- 14. Tabla de Items de Venta (Módulo Ventas y Stock)
-- ============================================
...
-- ============================================
-- 15. Tabla de Movimientos de Inventario (Módulo Ventas y Stock)
-- ============================================
...
-- Índice único solo para códigos de barras que existen (permite NULL)
...
-- IMPORTANTE: No consultar la tabla users dentro de su propia política (causa recursión infinita)
...
-- Políticas para system_settings (sin recursión)
...
-- Solo admin puede escribir (sin consultar users para evitar recursión)
...
-- ✅ SCRIPT COMPLETADO
-- ============================================
-- La base de datos ha sido recreada completamente
-- 
-- PRÓXIMOS PASOS:
-- 1. Crear usuarios en Authentication de Supabase
-- 2. Insertar registros en la tabla 'users' con el mismo ID del usuario de auth
-- 3. Crear sucursales si es necesario
-- 4. ¡Listo para usar!
-- ============================================
